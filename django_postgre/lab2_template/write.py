...
def write_learners():
    ...
    learner_john.save()
    learner_ivan = Learner(first_name = 'Ivan', last_name = 'Ivanoff', dob = date(1985, 4, 30), occupation = 'developer',
                           social_link = 'https://www.facebook.com/ivan/', phone_number = 89567246578)
    learner_ivan.save()
