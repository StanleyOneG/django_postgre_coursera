...
def populate_course_lessons_relationships():
    ...
    # Add lessons
    cloud_lesson = Lesson.objects.create(title = "Intro to cloud computing", course = course_cloud_app,
                                         content = "How to get started with cloud computing")
    cloud_lesson.save()
    python_lesson = Lesson.objects.create(title = "Intro to python", course = course_python,
                                          content = "Why python?")
    python_lesson.save()
    print("Course lessons relationships saved...")
...
populate_course_lessons_relationships()